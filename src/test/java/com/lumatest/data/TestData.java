...
public class TestData {
    ...
    public static final String BASE_TITLE = "Home Page";
    ...
    public static final String WHATS_NEW_TITLE = "What'" +
            "s New";
    ...
    public static final String DRIVEN_BACKPACK_PRODUCT_PAGE_BREADCRUMBS_MENU_TEXT = "Home Gear Bags Driven Backpack";
